...
module.exports = {
  ...
  base: '/vue3-composition-admin-docs/',
  head: [
    [
      'link',
      {
  ...
  // ga: 'UA-109340118-1'
  themeConfig: {
    repo: 'armour/vue3-composition-admin -template',
    docsRepo: 'armour/vue3-composition-admin-docs',
    docsDir: 'docs',
    editLinks: true,
    sidebarDepth: 3,
    ...
    //   indexName: 'vue3-composition-admin -template'
    // },
    locales: {
      '/': {
        ...
        sidebar: {
          '/guide/': [
            ...
            {
              title: 'Migrate',
              children: getSidebarByCategory('migrate', 'en')
            },
            {
              title: 'Other',
      ...
      '/zh/': {
        ...
        sidebar: {
          '/zh/guide/': [
            ...
            {
              title: 'vue2迁移vue3改变',
              children: getSidebarByCategory('migrate', 'zh')
            },
            {
              title: '其它',
  ...
  locales: {
    '/': {
      ...
      description: 'A  vue3 admin template base on  typescript'
    },
    '/zh/': {
      lang: 'zh-CN',
      description: '一个基于 typescript 的神奇的 vue3 管理平台模版'
    }
  }
}
